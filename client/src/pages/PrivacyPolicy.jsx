    ...
    <div style={s.page}>
      <div style={s.container}>
        ...
        <Section title="1. Información general">
          <P>SRAutomatic SpA ("nosotros", "la empresa") opera la plataforma SRServi disponible en <strong>mantraxtools.store</strong>. Esta Política de Privacidad describe cómo recopilamos, usamos, almacenamos y protegemos la información personal de nuestros usuarios.</P>
