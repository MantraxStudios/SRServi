  ...
  return (
    <div style={s.page}>
      <div style={s.container}>
        ...
        <Section title="8. Planes y pagos">
          <P>SRServi puede ofrecer planes gratuitos y de pago. Los términos específicos de cada plan se detallan en la plataforma al momento de la contratación. Los pagos no son reembolsables salvo lo que exija la ley aplicable.</P>
        </Section>

        <Section title="9. Limitación de responsabilidad">
          <P>SRServi se provee "tal cual" y "según disponibilidad". No garantizamos que la plataforma esté disponible en todo momento sin interrupciones.</P>
          <P>En ningún caso SRAutomatic SpA será responsable por daños indirectos, incidentales o consecuentes derivados del uso o imposibilidad de uso de la plataforma.</P>
        ...
        <Section title="11. Terminación">
          <P>Podemos suspender o cancelar tu acceso a SRServi en cualquier momento si violás estos términos, sin previo aviso y sin responsabilidad hacia vos.</P>
          <P>Podés cancelar tu cuenta en cualquier momento contactándonos. Tras la cancelación, tus datos serán eliminados conforme a nuestra Política de Privacidad.</P>
        </Section>
